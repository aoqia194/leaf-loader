...
public final class Log {
    ...
    public static void logFormat(LogLevel level, LogCategory category, String format,
        Object... args) {
        LogHandler handler = Log.handler;
        if (!handler.shouldLog(level, category)) {
            return;
    ...
    private static void log(LogHandler handler, LogLevel level, LogCategory category, String msg,
        Throwable exc) {
