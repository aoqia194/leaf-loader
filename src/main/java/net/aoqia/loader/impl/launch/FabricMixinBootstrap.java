...
import net.aoqia.loader.impl.util.mappings.MixinIntermediaryDevRemapper;
...
public final class FabricMixinBootstrap {
	...
	public static void init(EnvType side, LeafLoaderImpl loader) {
		...
		if (LeafLauncherBase.getLauncher().isDevelopment()) {
			MappingConfiguration mappingConfiguration = LeafLauncherBase.getLauncher().getMappingConfiguration();
