...
public final class SystemProperties {
	...
	public static final String SKIP_EMBEDDED_PROVIDER = "fabric.skipEmbeddedProvider";
	// game paths for common/client/server, replaces lookup from class path if present, env specific takes precedence
	public static final String GAME_PATH = "fabric.gamePath";
	public static final String GAME_PATH_CLIENT = "fabric.gamePath.client";
	public static final String GAME_PATH_SERVER = "fabric.gamePath.server";
