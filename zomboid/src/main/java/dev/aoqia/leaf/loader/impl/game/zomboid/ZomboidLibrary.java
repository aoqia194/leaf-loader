...
enum ZomboidLibrary implements LibraryType {
	...
	LOG4J_PLUGIN("net/minecrell/terminalconsole/util/LoggerNamePatternSelector.class"), // in terminalconsoleappender, used by loom's log4j config
	...
	static final ZomboidLibrary[] LOGGING = { LOG4J_API, LOG4J_CORE, LOG4J_CONFIG, LOG4J_PLUGIN, GSON, SLF4J_API, SLF4J_CORE };
